...
function getRandomMessage(type) {
    const msgs = {
        ...
        'general': ["add base files", "setup simple config", "add ui components", "work on basic logic", "setup simple backend", "auth and dashboard work", "some other updates", "cleanup logic"]
    };
