  ...
  const renderView = () => {
    switch (activeView) {
      case "profile":
        return (
          <ProfilePage
            user={studentData?.user || user}
            room={studentData?.room}
          />
        );
      case "health":
        return <HealthRecordView user={studentData?.user || user} />;
      case "gatepass":
        return (
          <GatePassView
            user={studentData?.user}
            gatePass={studentData?.gatePass}
            room={studentData?.room}
      ...
      case "payment":
        return <FeePaymentView user={user} />;
      case "mess":
        return <MessMenuView menu={studentData?.messMenu} />;
      case "parcel":
        return (
          <ParcelView
            user={user}
            parcels={studentData?.parcels}
            refreshData={fetchData}
          />
        );
      case "emergency":
        return (
          <EmergencyView
            user={user}
            alerts={studentData?.emergencyAlerts}
            refreshData={fetchData}
          />
        );
      case "lost-found":
        return (
          <LostAndFoundView
            user={user}
            items={studentData?.lostAndFoundItems}
            refreshData={fetchData}
          />
        );
      case "chat":
  ...
  return (
    ...
    >
      ...
      <main
        ...
        className="custom-scrollbar print:overflow-visible print:p-0"
      >
        <div
          key={activeView}
