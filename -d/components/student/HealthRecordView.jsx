...
export default function HealthRecordView({ user }) {
  ...
  if (isLoading)
    return (
      <div style={{ padding: "2rem", color: "var(--muted)", fontSize: 13 }}>
        Loading Health Record…
      </div>
    );
  if (error)
    return (
      <div style={{ padding: "2rem", color: "var(--red)", fontSize: 13 }}>
        {error}
      </div>
    );
  if (!record)
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            >
              Last check-up:{" "}
              {new Date(record.lastMedicalCheckup).toLocaleDateString()}
            </div>
          </div>
        </div>
        <span
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          >
            ...
            >
              ...
              >
                {record.emergencyContact.relation}
              </div>
              <div
                style={{
                  display: "flex",
              ...
              {record.existingMedicalConditions.length > 0 && (
                ...
                >
                  ...
                  <div style={{ fontSize: 13, color: "var(--text)" }}>
                    {record.existingMedicalConditions.join(", ")}
                  </div>
                </div>
              )}
              <div>
            ...
            {[
              {
                ...
                lines: [
                  record.doctorDetails.name,
                  record.doctorDetails.hospital,
                  record.doctorDetails.phone,
                ],
              },
              {
                label: "Health Insurance",
                lines: [
                  record.healthInsuranceDetails.providerName,
                  record.healthInsuranceDetails.policyNumber,
                ],
              },
            ].map(({ label, lines }) => (
              <div
