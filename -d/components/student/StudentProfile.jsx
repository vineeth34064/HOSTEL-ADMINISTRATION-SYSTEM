...
const StudentProfile = ({ user, room }) => (
      ...
      {user ? (
        <div className="space-y-2 text-slate-700">
          ...
          <p>
            ...
            <span className={user.feePaid ? "text-green-500" : "text-red-500"}>
    ...
    <Card>
      ...
      {room ? (
        ...
        <p className="text-slate-500">
          Room not allocated yet. Please pay your fees.
        </p>
      )}
    </Card>
    <Card>
      ...
      {user && user.guardian ? (
        <div className="space-y-2 text-slate-700">
          ...
          <p>
            <strong>Contact Number:</strong> {user.guardian.contactNumber}
          </p>
        </div>
      ) : (
