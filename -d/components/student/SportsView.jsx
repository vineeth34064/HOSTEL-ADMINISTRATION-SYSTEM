      ...
      >
        ...
        >
          <div>
            ...
            >
              Catch the latest tournament highlights, match schedules, and
              victory moments from across campus.
            </div>
          </div>
          <motion.div
            ...
            >
              ...
              >
                <div className="hms-form-row">
                  ...
                  <input
                    className="hms-input"
                    placeholder="e.g. Football Trials Today"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                  />
                </div>
                <div className="hms-form-row">
                  <label className="hms-label">Details</label>
                  <textarea
                    className="hms-input"
                    placeholder="Timing, venue, registration info…"
                    value={message}
                ...
                <div className="hms-form-row">
                  <label className="hms-label">Related Link (optional)</label>
                  <input
                    className="hms-input"
                    placeholder="https://…"
                    value={link}
          ...
          {isLoading ? (
                  ...
                  <motion.div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 6px 20px rgba(184,149,46,0.15)";
                    }}
                    onMouseLeave={(e) => {
            ...
            >
              ...
              <div style={{ fontSize: 13, color: "var(--muted)" }}>
                No sports announcements yet. Stay tuned!
              </div>
            </motion.div>
          )}
        </div>
