  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            >
              {leaves?.length || 0} request{leaves?.length !== 1 ? "s" : ""}{" "}
              submitted
            </div>
          </div>
        </div>
          ...
          leaves.map((leave) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`hms-pill ${statusMap[leave.status] || "gray"}`}
                >
                  {leave.status}
                </span>
              </div>
      ...
      >
        ...
        >
          <div className="hms-form-row">
            <label className="hms-label">From Date</label>
            <input
              className="hms-input"
              type="date"
              value={fromDate}
          ...
          <div className="hms-form-row">
            <label className="hms-label">To Date</label>
            <input
              className="hms-input"
              type="date"
              value={toDate}
