          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card overflow-hidden relative">
              <div className="relative z-10">
                ...
                <div
                  className={`text-4xl font-black mb-1 tracking-tighter drop-shadow-sm ${user.feePaid ? "text-emerald-400" : "text-rose-400"}`}
                >
            ...
            <div className="glass-card dark:text-white">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold uppercase tracking-tighter text-blue-500">
                    {user.role}
                  </span>
                </div>
              </div>
