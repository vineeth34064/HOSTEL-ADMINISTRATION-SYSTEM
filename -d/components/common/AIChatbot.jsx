...
export default function AIChatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "bot",
      text: 'Hi! I\'m your Hostel AI Assistant. Ask me about the mess menu, fee status, gate passes, or say "report an issue" to file a complaint.',
      time: new Date(),
    },
  ]);
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { sender: "bot", text: res.reply, time: new Date() },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
    ...
    <>
      ...
      <motion.button
        ...
        style={{
          ...
          boxShadow: "0 8px 24px rgba(184,149,46,0.4)",
          color: "#fff",
        }}
                      ...
                      >
                        <div
                          style={{
                            ...
                            lineHeight: 1.55,
                            boxShadow: isMine
                              ? "0 4px 12px rgba(184,149,46,0.25)"
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    input.trim() && !isLoading
                      ? "0 4px 12px rgba(184,149,46,0.3)"
                      : "none",
                }}
              >
                <SendIcon />
