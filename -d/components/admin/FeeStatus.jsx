    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            {rate}% collection rate · {students.length} students
          </div>
        </div>
        <div
          style={{
      ...
      >
        <div className="hms-stat green">
          ...
          <div className="hms-stat-bar">
            <div
              className="hms-stat-bar-fill"
              style={{
                width: `${(paid / Math.max(students.length, 1)) * 100}%`,
        ...
        <div className="hms-stat red">
          ...
          <div className="hms-stat-bar">
            <div
              className="hms-stat-bar-fill"
              style={{
                width: `${(due / Math.max(students.length, 1)) * 100}%`,
                background: "var(--red)",
              }}
            />
          </div>
        ...
        <div className="hms-stat gold">
          ...
          <div className="hms-stat-bar">
            <div
              className="hms-stat-bar-fill"
              style={{ width: `${rate}%`, background: "var(--gold)" }}
            />
          </div>
        </div>
      </div>
              ...
              <tbody>
                {students.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td>
                      <span
                        className={`hms-pill ${s.feePaid ? "green" : "red"}`}
                      >
                        {s.feePaid ? "✓ Cleared" : "⚠ Due"}
                      </span>
                    </td>
                    <td>
                      {!s.feePaid && (
