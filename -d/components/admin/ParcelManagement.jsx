      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            >
              {pending} awaiting pickup · {parcels.length} total
            </div>
          </div>
        </div>
        <button
            ...
            <table className="hms-table">
              ...
              <tbody>
                {parcels.map((p) => (
                  <tr key={p.id}>
                    <td>
                      <div className="name">{p.studentName}</div>
                      <div className="sub">{p.rollNumber}</div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`hms-pill ${p.pickedUp || p.collected ? "green" : "amber"}`}
                      >
                    ...
                    <td>
                      {!p.pickedUp && !p.collected && (
                        <button
                          ...
                          onClick={() =>
                            api.markParcelPickedUp(p.id).then(refreshData)
                          }
                        >
                          Mark Picked Up
                        </button>
