...
const typeBg = {
  Medical: "rgba(201,64,64,0.06)",
  Fire: "rgba(196,124,32,0.06)",
  Security: "rgba(184,149,46,0.06)",
  Other: "rgba(40,114,212,0.06)",
};
      ...
      >
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <span className={`hms-pill ${isActive ? "red" : "green"}`}>
          ...
          >
            <span>
              <strong>Student:</strong> {alert.studentName} ({alert.rollNumber})
            </span>
            {alert.roomDetails && (
              <span>
                <strong>Room:</strong> {alert.roomDetails}
              </span>
            )}
      ...
      {active.length > 0 && (
        ...
        >
          ...
          <div style={{ fontSize: 13, fontWeight: 600, color: "var(--red)" }}>
            {active.length} active emergency alert{active.length > 1 ? "s" : ""}{" "}
            require attention
          </div>
        </div>
      )}
                ...
                <div>
                  <div
                    style={{
                      ...
                      color: "var(--muted)",
                      marginBottom: 10,
                      paddingTop: active.length > 0 ? "0.75rem" : 0,
                      borderTop:
                        active.length > 0 ? "1px solid var(--border)" : "none",
                    }}
                  >
                    Resolved
                  </div>
