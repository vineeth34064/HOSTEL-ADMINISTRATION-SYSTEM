...
const ComplaintView = ({ user, complaints, refreshData }) => {
    ...
    return (<motion.div initial="hidden" animate="visible" variants={container} style={{ maxWidth: 780 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {complaints && complaints.length > 0 ? complaints.map((c) => (<motion.div key={c.id} variants={item} style={{
                background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 14, overflow: 'hidden',
                        ...
                        <div style={{ padding: '1rem 1.25rem' }}>
                            ...
                            {c.createdAt && (<div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 8 }}>
