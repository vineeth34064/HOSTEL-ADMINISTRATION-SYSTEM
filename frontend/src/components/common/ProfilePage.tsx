...
const ProfilePage: React.FC<ProfilePageProps> = ({ user, room, isAdmin }) => {
  if (!user) return <div className="flex items-center justify-center h-64 dark:text-white">Loading Profile...</div>;
