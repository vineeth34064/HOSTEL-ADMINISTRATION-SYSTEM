...
const LostAndFoundManagement = ({ items, refreshData }) => {
    ...
    return (<motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="hms-card">
                <div style={{ padding: 0 }}>
                    {!items || items.length === 0 ? (<div style={{ padding: '2.5rem', textAlign: 'center', color: 'var(--muted)', fontSize: 13 }}>No items on the Lost &amp; Found board.</div>) : (<table className="hms-table">
                            <thead><tr>
