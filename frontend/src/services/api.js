...
export async function register(name, email, password, rollNumber, contactNumber) {
...
export async function sendEmergencyAlert(studentId, data) {
    return request('/emergencies', { method: 'POST', body: JSON.stringify(data) });
}
...
// AI Chatbot
export async function sendAIChatbotMessage(message, previousState, contextData = null) {
